...
#
# Created: Sat May  3 21:43:47 2014
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.groupBox.setGeometry(QtCore.QRect(600, 20, 361, 131))
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(10, 30, 179, 89))
        ...
        self.cal_O = QtGui.QPushButton(self.verticalLayoutWidget)
        self.cal_O.setObjectName(_fromUtf8("cal_O"))
        self.horizontalLayout.addWidget(self.cal_O)
        self.cal_X = QtGui.QPushButton(self.verticalLayoutWidget)
        self.cal_X.setObjectName(_fromUtf8("cal_X"))
        self.horizontalLayout.addWidget(self.cal_X)
        self.cal_Y = QtGui.QPushButton(self.verticalLayoutWidget)
        self.cal_Y.setObjectName(_fromUtf8("cal_Y"))
        self.horizontalLayout.addWidget(self.cal_Y)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.cal_O.setText(_translate("MainWindow", "O", None))
        self.cal_X.setText(_translate("MainWindow", "X", None))
        self.cal_Y.setText(_translate("MainWindow", "Y", None))
